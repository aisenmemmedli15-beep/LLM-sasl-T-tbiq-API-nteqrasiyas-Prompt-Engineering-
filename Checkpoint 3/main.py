...
# Standart Strukturlu Analiz Funksiyası 
def analyze_text(user_input: str):
    system_prompt = (
        "Sən peşəkar bir Mətn Analizi və Xülasələndirmə AI assistentisən. "
        "Sənə təqdim olunan mətni analiz etmeli və tələb olunan JSON strukturuna uyğun cavab verməlisən."
    )
...
def analyze_text_stream(user_input: str):
    try:
        response = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "Sən peşəkar bir Mətn Analizi və Xülasələndirmə AI assistentisən. Mətni sərbəst şəkildə analiz et."},
        ...
        print(f"Streaming xətası: {e}")

# Proqramı yoxlamaq üçün test hissəsi
if __name__ == "__main__":
    ...
    print("--- STANDART STRUKTURLU ANALİZ ---")
